# :wave: Say hi to Siddharth Kumar Rai :wave:
...
```sh
shopify theme init [ NAME OF YOUR THEME ] --clone-url https://github.com/siddharthkumarrai/shopify_starter_template.git
```
